<div>
    <div class="max-w-2xl">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500 mt-1">Configure system-wide CRM settings.</p>
        </div>
            ...
            <form wire:submit="save" class="space-y-6">
                <div>
                    ...
                    <p class="text-xs text-gray-500 mb-3">
                        Number of days after which a client is marked as "Late" if no follow-up update has been made.
                    </p>
