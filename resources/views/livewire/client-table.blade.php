            ...
            <table class="w-full text-sm text-right">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        @endif
                        <th class="px-6 py-3.5 text-xs font-semibold text-gray-500 tracking-wider">عدد الأيام المتأخرة</th>
                ...
                <tbody class="divide-y divide-gray-100">
                        ...
                        <td class="px-6 py-4">
                            @if($client->phone)
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-700 font-medium" dir="ltr">{{ $client->formatted_phone }}</span>
                                </div>
                            @else
                    ...
                    @empty
                    <tr>
                        <td colspan="{{ auth()->user()->isFollower() ? '7' : '8' }}" class="px-6 py-12 text-center">
